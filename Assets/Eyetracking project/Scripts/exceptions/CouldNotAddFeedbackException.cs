...
/// <summary>
/// Gets thrown when the feedback could not be added
/// </summary>
public class CouldNotAddFeedbackException : InvalidOperationException
{
    private string message;

    /// <summary>
    /// Makes an instance of the CouldNotAddFeedbackException.
    /// </summary>
    /// <param name="message">the error message.</param>
    public CouldNotAddFeedbackException(string message) : base()
    {
