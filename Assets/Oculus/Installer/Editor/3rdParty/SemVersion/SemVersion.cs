// This came from https://github.com/maxhauser/semver/blob/master/Semver/SemVersion.cs
// It's MIT licensesed.
// Only slight modification to remove pointless extension method
...
namespace Oculus.Installer.ThirdParty.Semver
{
    /// <summary>
...
#pragma warning restore CA1801 // Parameter unused
        ...
        public override string ToString()
        {
            ...
            var estimatedLength = 4 + Digits(Major) + Digits(Minor) + Digits(Patch)
